...
download_link = tree.xpath("//div[@class='middle-box']/div[@class='w box']/"
                           "div[@class='box download-box']/div[@class='media-box']/"
                           "div[@class='media-list']/ul/li/div[@class='fr']//@href")
print(download_link)
ed2k_list = []
...
target = open('C:\\Users\\NZMCBQ\Desktop\download_list_filter.txt', 'w')
for i in ed2k_list_filter:
    target.write(i)
    target.write('\n')
target.close()
